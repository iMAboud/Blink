...
public partial class ApplicationSettingsView : UserControl, IDisposable
{
    ...
    {
        add => ViewModel.SettingsImported += value;
        remove => ViewModel.SettingsImported -= value;
    }
    ...
    private void OnImagePrintSettingsClick(object? sender, RoutedEventArgs e)
    {
        if (TopLevel.GetTopLevel(this) is Window window)
        {
            ViewModel.ShowImagePrintSettings(window);
        }
    }
    ...
    private async void OnExportClick(object? sender, RoutedEventArgs e)
    {
        ...
        IStorageFile? file = await StorageProvider.SaveFilePickerAsync(new FilePickerSaveOptions
        {
            ...
            SuggestedFileName = $"Blink-{Helpers.GetApplicationVersion()}-{machineName}-backup.bkb",
            DefaultExtension = "bkb",
            FileTypeChoices =
            [
                new FilePickerFileType("Blink Backup (*.bkb)") { Patterns = ["*.bkb"] },
                new FilePickerFileType("ShareX Backup (*.sxb)") { Patterns = ["*.sxb"] },
    ...
    private async void OnImportClick(object? sender, RoutedEventArgs e)
    {
        ...
        var files = await StorageProvider.OpenFilePickerAsync(new FilePickerOpenOptions
        {
            ...
            FileTypeFilter =
            [
                new FilePickerFileType("Blink / ShareX Backup (*.bkb, *.sxb)") { Patterns = ["*.bkb", "*.sxb"] },
                FilePickerFileTypes.All
            ]
        });
