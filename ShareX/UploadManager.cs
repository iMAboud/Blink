...
namespace ShareX
{
    public static class UploadManager
    {
        ...
        public static void UploadFile(TaskSettings taskSettings = null)
        {
            ...
            {
                ofd.Title = "Blink - " + Strings.UploadManager_UploadFile_File_upload;
        ...
        public static void UploadFolder(TaskSettings taskSettings = null)
        {
            ...
            string selectedPath = FileHelpers.BrowseFolder("Blink - " + Strings.UploadManager_UploadFolder_Folder_upload, initialDirectory);
        ...
        public static void ClipboardUpload(TaskSettings taskSettings = null)
        {
            ...
            catch (ExternalException e)
            {
                ...
                if (MessageBox.Show("\"" + e.Message + "\"\r\n\r\n" + Strings.WouldYouLikeToRetryClipboardUpload, "Blink - " + Strings.ClipboardUpload,
