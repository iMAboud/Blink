...
public sealed class ShareXClickerGame
{
    ...
    [
        ...
        new("blink-bot", "Blink Bot", LucideIcons.bot, 100, 6, 100),
        ...
        new("blink-datacenter", "Blink Datacenter", LucideIcons.database, 120000, 4000, 50000),
        new("capture-cloud", "Capture Cloud", LucideIcons.cloud, 700000, 20000, 250000),
        new("blink-satellite", "Blink Satellite", LucideIcons.satellite, 4000000, 100000, 1000000)
    ];
