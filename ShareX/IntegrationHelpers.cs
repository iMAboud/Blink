...
namespace ShareX
{
    public static class IntegrationHelpers
    {
        ...
        private static readonly string ShellExtMenuName = "Blink";
        ...
        private static readonly string ShellExtEditName = "BlinkImageEditor";
        ...
        private static readonly string ShellCustomUploaderExtensionValue = "Blink.sxcu";
        private static readonly string ShellCustomUploaderAssociatePath = $@"Software\Classes\{ShellCustomUploaderExtensionValue}";
        private static readonly string ShellCustomUploaderAssociateValue = "Blink custom uploader";
        ...
        private static readonly string ShellImageEffectExtensionValue = "Blink.sxie";
        private static readonly string ShellImageEffectAssociatePath = $@"Software\Classes\{ShellImageEffectExtensionValue}";
        private static readonly string ShellImageEffectAssociateValue = "Blink image effect";
        ...
        {
            return ShortcutHelpers.CheckShortcut(Environment.SpecialFolder.SendTo, "Blink", Application.ExecutablePath);
        }

        public static bool CreateSendToMenuButton(bool create)
        {
            return ShortcutHelpers.SetShortcut(create, Environment.SpecialFolder.SendTo, "Blink", Application.ExecutablePath);
        }
        ...
        public static void SteamShowInApp(bool showInApp)
        {
            ...
            MessageBox.Show(Strings.ApplicationSettingsForm_cbSteamShowInApp_CheckedChanged_For_settings_to_take_effect_ShareX_needs_to_be_reopened_from_Steam_,
                "Blink", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
