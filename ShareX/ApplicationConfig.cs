...
namespace ShareX
{
    public class ApplicationConfig : SettingsBase<ApplicationConfig>
    {
        ...
        public HotkeyType TrayLeftClickAction = HotkeyType.OpenSettings;
        public HotkeyType TrayLeftDoubleClickAction = HotkeyType.None;
        ...
        public bool UseCustomScreenshotsPath = true;
        public string CustomScreenshotsPath = @"%MyPictures%\Blink";
        ...
        public string CustomScreenshotsPath2 { get; set; } = @"%MyPictures%\Blink";
